...
<form class="form-horizontal" action="${pageContext.request.contextPath}/UserServlet?method=userLogin" method="post">
 ...
 <div class="form-group">
    ...
    <div class="col-sm-6">
      <input type="text" name="username" class="form-control" value="${username}" id="username" placeholder="请输入用户名">
    </div>
  </div>
   <div class="form-group">
   ...
   <div class="form-group">
    ...
    <div class="col-sm-3">
      <input type="text" name="checkCode" class="form-control" id="inputPassword4" placeholder="请输入验证码">
    </div>
    <div class="col-sm-3">
      <img src="${pageContext.request.contextPath}/CodeServlet"/>
    </div>
   ...
   <div class="form-group">
    <div class="col-sm-offset-2 col-sm-10">
      <div class="checkbox">
        <label>
          <input name="auto_login" type="checkbox"> 自动登录
        </label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <label>
          <input name="remUser" type="checkbox"> 记住用户名
        </label>
      </div>
    </div>
  </div>
