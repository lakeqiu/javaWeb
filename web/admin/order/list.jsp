                                ...
                                <c:forEach items="${page.list}" var="o" varStatus="status">
										<tr onmouseover="this.style.backgroundColor = 'white'"
											...
											<td align="center" style="HEIGHT: 22px">
												<input type="button" value="订单详情" width="70%" id="${o.oid}" class="myClass"/>
												...
												<table border="1" width="100%">
													...
													<tr>
														<td><img width="50px" src="${ pageContext.request.contextPath }/products/1/c_0001.jpg"></td>
														<td>xxxx</td>
														<td>xxxx</td>
														<td>xxxx</td>
													</tr>--%>
		...
		$(function(){
			...
			$(".myClass").click(function(){
				...
				if(txt=="订单详情"){
					...
					var url="/store_war_exploded/AdminOrderServlet";
					var obj={"method":"findOrderByOidWithAjax","oid":id};
					...
					$.post(url,obj,function(data){
						...
						$.each(data,function(i,obj){
							var td="<tr><td><img src='/store_war_exploded/"+obj.product.pimage+"' width='50px'/></td><td>"+obj.product.pname+"</td><td>"+obj.product.shop_price+"</td><td>"+obj.quantity+"</td></tr>";
							$tb.append(td);
						})
					},"json");
